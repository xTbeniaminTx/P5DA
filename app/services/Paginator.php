...
class Paginator
{
     ...
     * @var string
     */
    private $_paginatorStartCssClass = 'pagination--start page-item';
    ...
    private function createLiCurrentOrNot(string $path, int $counter): string
    {
        ...
        if ($counter == $this->_pageIdentifierFromGet) {
            $html .= '<li class="current page-item active"><a class="page-link" href="#">' . $currentTextAndOrLink . '<span class="sr-only">(current)</span></a></li>';
        } else {
    ...
    private function createLiFirstAndSecond(string $path): string
    {
        ...
        $html .= '<li><a class="page-link" href="' . $path . $this->_instance . '=1">1</a></li>';
        $html .= '<li><a class="page-link" href="' . $path . $this->_instance . '=2">2</a></li>';
    ...
    public function page_links(string $path = '?'): string
    {
        ...
        if ($lastpage > 1) {
            $pagination .= '<ul class="pagination justify-content-center ' . $this->_paginatorUlCssClass . '" data-pagination-current="' . $this->_pageIdentifierFromGet . '" data-pagination-prev="' . $prevDataAttribute . '" data-pagination-next="' . $nextDataAttribute . '" data-pagination-length="' . $lastpage . '">';
            ...
            if ($this->_pageIdentifierFromGet > 1) {
                ...
                $pagination .= '<li class="' . $this->_paginatorStartCssClass . '"><a class="page-link" href="#">' . $this->_paginatorStartChar . '</a></li>';
            }
            ...
            if ($lastpage < 7 + ($this->_adjacent * 2)) {
                ...
                $pagination .= '<li><a class="page-link" href="' . $path . $this->_instance . '=' . $tmpSave . '">' . $tmpSave . '</a></li>';
                $pagination .= '<li><a class="page-link" href="' . $path . $this->_instance . '=' . $lastpage . '">' . $lastpage . '</a></li>';
            ...
            if ($this->_pageIdentifierFromGet < $counter - 1) {
                ...
                $pagination .= '<li class="' . $this->_paginatorEndCssClass . '"><a class="page-link" href="#">' . $this->_paginatorEndChar . '</a></li>';
            }
